...
public class Tianchi {
	public static void main(String[] args) throws Exception {
		...
		String line = "";
		// 读入训练数据
		BufferedReader br = readFile("C:\\Users\\yrf\\Desktop\\weibo_train_data.txt");
		...
		// 读入预测数据
		br = readFile("C:\\Users\\yrf\\Desktop\\weibo_predict_data.txt");
		PrintWriter pt = writeFile("C:\\Users\\yrf\\Desktop\\weibo_result_data.txt");
		// 直接抄答案
		while ((line = br.readLine()) != null) {
